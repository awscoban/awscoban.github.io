...
- **File Storage**: đây là loại lưu trữ theo tệp tin và thư mục trên mà ta thường sử dụng. Phù hợp khi cần chia sẻ dữ liệu giữa nhiều máy với nhau. AWS cung cấp các giải pháp File Storage như [Elastic File System (EFS)](/2025/12/24/efs), hay [FSx](/2026/05/07/fsx).
