...
Các dịch vụ trong vùng này có public endpoint và DNS, có thể truy cập từ Internet. Ví dụ: [S3](/2025/11/30/s3-fundamental) (lưu trữ), [API Gateway](/2026/01/28/api-gateway) (quản lý API), [CloudFront](/2026/02/20/cloudfront) (CDN), sẽ được trình bày trong các bài sau. 
...
Các dịch vụ trong một VPC chỉ có thể truy cập từ các dịch vụ khác trong cùng VPC, trong một mạng khác kết nối với VPC đó (có thể là một VPC khác hoặc từ mạng on-premise kết nối với VPC bằng [VPN](/2026/04/12/vpn) hoặc [Direct Connect](/2026/04/18/direct-connect)). 
