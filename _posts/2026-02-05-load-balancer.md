...
Trên AWS, Elastic Load Balancer (ELB) tự động phân phối lưu lượng mạng đến nhiều tài nguyên đích (gọi là **target**) như [EC2 Instance](/2025/12/16/ec2-fundamental), [ECS](/2026/05/12/ecs) container, hoặc các địa chỉ IP của máy chủ, trong một hoặc nhiều AZ. ELB cũng tự động theo dõi tình trạng của các tài nguyên đích, đảm bảo chỉ phân phối lưu lượng đến các tài nguyên đang hoạt động (*healthy target*). 
