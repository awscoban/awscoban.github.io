...
- Mã hoá dữ liệu khi lưu trữ chỉ có thể bật khi tạo mới DB Instance, **không thể bật cho DB Instance đã có**. Tuy nhiên, có một cách đi đường vòng là:
    ...
    - __Sao chép (*copy*) snapshot__ đó thành một snapshot mới. Thao tác sao chép này cho phép mã hoá bản sao của snapshot. [Đọc thêm tại đây](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_CopySnapshot.html#USER_CopyDBSnapshot).
