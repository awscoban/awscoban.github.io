...
Đây là phương thức thuê Instance mới hơn, linh hoạt hơn Reserved Instance. Người dùng cam kết trả một mức phí cố định hàng giờ trong thời gian dài (vẫn là 1 hoặc 3 năm), đổi lại được giảm giá so với mức phí On-Demand, khi sử dụng EC2 hoặc các dịch vụ tính toán khác như [Fargate](/2026/05/12/ecs#fargate) (*container*), [Lambda](/2026/01/18/lambda-fundamental) (*serverless computing*), SageMaker (Học Máy). Mức phí cố định này áp dụng bất kể người dùng sử dụng loại Instance, hệ điều hành, kích thước, hay Region nào. 
